package github.pitbox46.lithiumforge.mixin;

import github.pitbox46.lithiumforge.LithiumForge;
import github.pitbox46.lithiumforge.common.config.LithiumConfig;
import github.pitbox46.lithiumforge.common.config.Option;
...
public class LithiumMixinPlugin implements IMixinConfigPlugin {
    private static final String MIXIN_PACKAGE_ROOT = "github.pitbox46.lithiumforge.mixin.";

    private final Logger logger = LogManager.getLogger("FLiBe");
    ...
    public void onLoad(String mixinPackage) {
        try {
            this.config = LithiumConfig.load(new File("./config/lithiumforge.properties"));
        } catch (Exception e) {
        ...
        LithiumForge.CONFIG = this.config;
    }
