package github.pitbox46.lithiumforge.mixin.ai.poi;

import com.mojang.datafixers.DataFixer;
import com.mojang.serialization.Codec;
import github.pitbox46.lithiumforge.common.util.Distances;
import github.pitbox46.lithiumforge.common.world.interests.PointOfInterestSetExtended;
import github.pitbox46.lithiumforge.common.world.interests.PointOfInterestStorageExtended;
import github.pitbox46.lithiumforge.common.world.interests.RegionBasedStorageSectionExtended;
import github.pitbox46.lithiumforge.common.world.interests.iterator.NearbyPointOfInterestStream;
import github.pitbox46.lithiumforge.common.world.interests.iterator.SinglePointOfInterestTypeFilter;
import github.pitbox46.lithiumforge.common.world.interests.iterator.SphereChunkOrderedPoiSetSpliterator;
...
public abstract class PointOfInterestStorageMixin extends SectionStorage<PoiSection> implements PointOfInterestStorageExtended {
    public PointOfInterestStorageMixin(Path p_223509_, Function<Runnable, Codec<PoiSection>> p_223510_, Function<Runnable, PoiSection> p_223511_, DataFixer p_223512_, DataFixTypes p_223513_, boolean p_223514_, RegistryAccess p_223515_, LevelHeightAccessor p_223516_) {
        super(p_223509_, p_223510_, p_223511_, p_223512_, p_223513_, p_223514_, p_223515_, p_223516_);
    }
