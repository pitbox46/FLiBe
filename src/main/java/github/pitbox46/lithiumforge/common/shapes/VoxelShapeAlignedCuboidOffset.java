...
import github.pitbox46.lithiumforge.common.shapes.lists.OffsetFractionalDoubleList;
...
public class VoxelShapeAlignedCuboidOffset extends VoxelShapeAlignedCuboid {
    ...
    private double calculatePenetration(AxisCycle dir, AABB box, double maxDist) {
        return switch (dir) {
            case NONE ->
                    VoxelShapeAlignedCuboidOffset.calculatePenetration(this.minX, this.maxX, this.xSegments, this.xOffset, box.minX, box.maxX, maxDist);
            case FORWARD ->
                    VoxelShapeAlignedCuboidOffset.calculatePenetration(this.minZ, this.maxZ, this.zSegments, this.zOffset, box.minZ, box.maxZ, maxDist);
            case BACKWARD ->
                    VoxelShapeAlignedCuboidOffset.calculatePenetration(this.minY, this.maxY, this.ySegments, this.yOffset, box.minY, box.maxY, maxDist);
