...
public class VoxelShapeAlignedCuboid extends VoxelShapeSimpleCube {
    ...
    private double calculatePenetration(AxisCycle dir, AABB box, double maxDist) {
        return switch (dir) {
            case NONE ->
                    VoxelShapeAlignedCuboid.calculatePenetration(this.minX, this.maxX, this.xSegments, box.minX, box.maxX, maxDist);
            case FORWARD ->
                    VoxelShapeAlignedCuboid.calculatePenetration(this.minZ, this.maxZ, this.zSegments, box.minZ, box.maxZ, maxDist);
            case BACKWARD ->
                    VoxelShapeAlignedCuboid.calculatePenetration(this.minY, this.maxY, this.ySegments, box.minY, box.maxY, maxDist);
