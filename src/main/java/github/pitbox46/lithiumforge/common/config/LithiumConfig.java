package github.pitbox46.lithiumforge.common.config;
...
public class LithiumConfig {
    private static final Logger LOGGER = LogManager.getLogger("LithiumForgeConfig");

    private static final String JSON_KEY_LITHIUM_OPTIONS = "lithiumforge:options";
...
//    }
    ...
    private LithiumConfig() {
        ...
        InputStream defaultPropertiesStream = LithiumConfig.class.getResourceAsStream("/assets/lithiumforge/lithiumforge-mixin-config-default.properties");
        ...
        InputStream dependenciesStream = LithiumConfig.class.getResourceAsStream("/assets/lithiumforge/lithiumforge-mixin-config-dependencies.properties");
...
//    TODO Make method for mod overrides
